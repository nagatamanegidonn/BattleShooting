...
void AnimationController::Add(int type, const std::string& path, float speed,int ainmNo)
{
...
void AnimationController::Play(int type, bool isLoop, 
	float startStep, float endStep, bool isStop, bool isForce, bool playmove)
{
	//現在のアニメーションタイプと違うなら もしくは isForceがtrueなら
